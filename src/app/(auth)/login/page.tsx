...
function LoginContent() {
  ...
  // Accept both spellings: the join page historically linked with ?redirect=
  const redirectTo =
  ...
  return (
    <Card className="shadow-xl">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Sign in to continue planning</CardDescription>
      </CardHeader>
